...
| 0 | `0x06` | Report ID |
| 1 | `0x26` | Command echo |
| 2 | `0x01` / `0x02` | **Limiter state** — `0x01`=limiter on, `0x02`=limiter off (inverted encoding) |
...
| `0x23` | Set USB input | `[2]` | 0–1 | `0x00`=USB Input 1, `0x01`=USB Input 2; silent — no Col02 event fires |
